...
interface DashboardProps extends PageProps {
    dashboardData: {
        ...
        recentActivities: { type: string; title: string; description: string; badge: string; color: string; timestamp: string }[];
                ...
                <div className="min-h-screen">
                    <div className="mx-auto space-y-6 p-4">
                        ...
                        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                            {isAdmin && <h1 className="text-2xl font-bold">Administrative Dashboard</h1>}
                            {!isAdmin && <h1 className="text-2xl font-bold">Record Officer Dashboard</h1>}
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-5">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-sm text-gray-500">Unread notifications and messages.</p>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {pdlByGender.length > 0 ? (
                                                ...
                                                {pdlByGender.map((item, index) => (
                                                    <div key={index} className="flex items-center gap-3">
                                                        ...
                                                        <span className="text-sm text-gray-600">
                                                            ...
                                                            {totalPDL > 0 ? ((item.value / totalPDL) * 100).toFixed(1) : 0}%)
                                                        </span>
                                                    </div>
                                                ))}
                                            </div>
                                        ...
                                        <div className="py-8 text-center text-gray-500">No demographic data available</div>
                                    )}
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {caseStatusData.length > 0 ? (
                                        ...
                                        <div className="py-8 text-center text-gray-500">No case data available</div>
                                    )}
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {monthlyAdmissions.length > 0 ? (
                                        ...
                                        <div className="py-8 text-center text-gray-500">No admission/release data available</div>
                                    )}
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {securityClassificationData.length > 0 ? (
                                        ...
                                        <div className="py-8 text-center text-gray-500">No security classification data available</div>
                                    )}
                                </CardContent>
                            </Card>
                            ...
                            <Card className="lg:col-span-2">
                                ...
                                <CardContent>
                                    {cellOccupancy.length > 0 ? (
                                                        ...
                                                        <div className="h-2 rounded-full bg-gray-200">
                                                            <div
                                                                className={`h-2 rounded-full ${
                                                                    isNearCapacity ? 'bg-red-500' : isUnderUtilized ? 'bg-green-500' : 'bg-blue-500'
                                                                }`}
                                        ...
                                        <div className="py-8 text-center text-gray-500">No cell occupancy data available</div>
                                    )}
                                </CardContent>
                            </Card>
                        </div>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {courtOrderTypes.length > 0 ? (
                                        ...
                                        <div className="py-8 text-center text-gray-500">No court order data available</div>
                                    )}
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {verificationStatusData.length > 0 ? (
                                        ...
                                        <div className="py-8 text-center text-gray-500">No verification data available</div>
                                    )}
                                </CardContent>
                            </Card>
                        </div>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    {personnelByPosition.length > 0 ? (
                                        ...
                                        <div className="py-8 text-center text-gray-500">No personnel data available</div>
                                    )}
                                </CardContent>
                            </Card>
                                    ...
                                    {(() => {
                                        ...
                                        return gctaData ? (
                                            <div>
                                                ...
                                                <div className="mb-2 text-sm text-muted-foreground">{gctaData.description}</div>
                                                ...
                                                <div className="mt-2 text-xs text-gray-500">
                                                    {totalTimeAllowances > 0 ? ((gctaData.count / totalTimeAllowances) * 100).toFixed(1) : 0}% of
                                                    total allowances
                                                </div>
                                            </div>
                                        ) : (
                                            <div className="py-8 text-center text-gray-500">No GCTA data available</div>
                                        );
                                    })()}
                                </CardContent>
                            </Card>
                                    ...
                                    {(() => {
                                        ...
                                        return tastmData ? (
                                            <div>
                                                ...
                                                <div className="mb-2 text-sm text-muted-foreground">{tastmData.description}</div>
                                                <div className="h-3 w-full rounded-full bg-gray-200">
                                                    <div
                                                        className="h-3 rounded-full transition-all duration-300"
                                                        style={{
                                                ...
                                                <div className="mt-2 text-xs text-gray-500">
                                                    {totalTimeAllowances > 0 ? ((tastmData.count / totalTimeAllowances) * 100).toFixed(1) : 0}% of
                                                    total allowances
                                                </div>
                                            </div>
                                        ) : (
                                            <div className="py-8 text-center text-gray-500">No TASTM data available</div>
                                        );
                                    })()}
                                </CardContent>
                            </Card>
                                            ...
                                            <div key={index} className="flex items-start gap-3 border-b border-gray-100 pb-3 last:border-b-0">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <p className="text-sm text-muted-foreground">
                                                        {activity.description.replace(/_/g, ' ').charAt(0).toUpperCase() +
                                                            activity.description.replace(/_/g, ' ').slice(1)}
                                                    </p>
